        ...
        return (
            <form className="form-inline">
                <div className="form-group" id="dogcog-block">
                    ...
                    />
                    <span>
                        {`-${getDogcogPercentage(dogcogTotalLevel).toFixed(
                            2,
                        )}%`}
                    </span>
                </div>
                <div
                    className={
                        'checkbox' + (!relicsCheckboxEnabled ? ' disabled' : '')
                    }
                >
                    <label style={checkboxLabelStyle}>{relicBonusLabel}</label>
                    <input
                        type="checkbox"
